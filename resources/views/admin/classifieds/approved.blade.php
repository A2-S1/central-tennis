...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h1>Classificados aprovados</h1>
    <div class="d-flex gap-2">
      <a href="{{ route('admin.classifieds.pending') }}" class="btn btn-sm btn-outline-primary">Pendentes</a>
  ...
  <div class="table-responsive">
    <table class="table table-sm align-middle">
      ...
      <tbody>
        ...
        @empty
        <tr><td colspan="6" class="text-center text-muted">Nenhum anúncio aprovado.</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
